...
class BoroccoMuseum extends StatefulWidget {
  const BoroccoMuseum({Key? key}) : super(key: key);

  @override
  State<BoroccoMuseum> createState() => _BoroccoMuseumState();
}

class _BoroccoMuseumState extends State<BoroccoMuseum> {
  @override
